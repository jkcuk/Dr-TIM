 ...
 */
public class IPDFactorPanorama3DGeometry extends StandardPanorama3DGeometry
{
	/**
	 ...
	 */
	public IPDFactorPanorama3DGeometry(Vector3D M, Vector3D theta0, Vector3D phi0, double interpupillaryDistance)
	{
	 ...
	 * Default constructor
	 */
	public IPDFactorPanorama3DGeometry()
	{
		super();
	}
	...
	public Ray getRayForAngles(double phi, double theta, Side side)
	{
		...
		Vector3D c = Vector3D.sum(
				M,	// midpoint
				Vector3D.crossProduct(d, theta0).getWithLength(0.5*interpupillaryDistance*side.toFactor()*getIPDFactor(phi, theta))
			);
