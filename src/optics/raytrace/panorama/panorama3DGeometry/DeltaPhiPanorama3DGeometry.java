 ...
 * 
 */
public class DeltaPhiPanorama3DGeometry extends StandardPanorama3DGeometry
{
	 ...
	 * @param deltaPhi	delta phi
	 */
	public DeltaPhiPanorama3DGeometry(Vector3D M, Vector3D theta0, Vector3D phi0, double interpupillaryDistance, double deltaPhi)
	{
	...
	public DeltaPhiPanorama3DGeometry(double deltaPhi)
	{
		super();
	 ...
	 * Default constructor
	 */
	public DeltaPhiPanorama3DGeometry()
	{
		this(0);
	}
	 ...
	 */
	@Override
	public Ray getRayForAngles(double phi0, double theta, Side side)
	{
		double phi = phi0 - 0.5*side.toFactor()*deltaPhi;
		...
		Vector3D c = Vector3D.sum(
				M,	// midpoint
				Vector3D.crossProduct(theta0, d).getWithLength(/*0.5*/0*interpupillaryDistance*side.toFactor())
			);
