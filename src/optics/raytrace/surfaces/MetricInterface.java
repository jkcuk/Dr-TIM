	...
	throws RayTraceException
	{
		...
		try
		{
			...
			return scene.getColourAvoidingOrigin(
					ray.getBranchRay(intersection.p, dPrime, intersection.t, ray.isReportToConsole()),	// creating the new ray using the original ray's getSecondaryRay method ensures the ray trajectory is recorded correctly
