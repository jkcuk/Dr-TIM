 ...
 */
public class PhaseHologramOfCylindricalLensSpiral_old extends PhaseHologram
{
	 ...
	 */
	public PhaseHologramOfCylindricalLensSpiral_old(
	...
	public PhaseHologramOfCylindricalLensSpiral_old(PhaseHologramOfCylindricalLensSpiral_old original) {
		super(original);
	...
	@Override
	public PhaseHologramOfCylindricalLensSpiral_old clone()
	{
		return new PhaseHologramOfCylindricalLensSpiral_old(this);
	}
