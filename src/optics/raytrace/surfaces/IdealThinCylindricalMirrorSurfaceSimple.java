 ...
 * @see optics.raytrace.surfaces.IdealThinCylindricalLensSurfaceSimple
 * (Unlike in the case of a thin hologram, the direction change is independent of wavelength.)
 * 
 * @author Johannes Courtial
 */
public class IdealThinCylindricalMirrorSurfaceSimple extends SurfacePropertyPrimitive
{
	private static final long serialVersionUID = 8917584872858012010L;

	// The centre of the ideal thin cylindrical lens.
	...
	public IdealThinCylindricalMirrorSurfaceSimple(IdealThinCylindricalMirrorSurfaceSimple original)
	{
		this(
	 ...
	 */
	@Override
	public IdealThinCylindricalMirrorSurfaceSimple clone()
	{
		return new IdealThinCylindricalMirrorSurfaceSimple(this);
	}
