 ...
 * @author johannes
 */
public class DistanceLabelledPlanes1Initialisation extends StudioInitialisation
{
	...
	public String getDescription() {
		return "Distance-labelled planes 10cm - 1m";
	}
	...
	private static void addZPlaneText(int zInCM, SceneObjectContainer scene, Studio studio)
	{
		scene.addSceneObject(EditableText.getCentredEditableText(
				...
				new Vector3D(0, -1.1*CM, zInCM*CM),	// centre
