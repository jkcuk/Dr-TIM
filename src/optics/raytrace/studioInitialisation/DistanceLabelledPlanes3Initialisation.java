 ...
 * @author johannes
 */
public class DistanceLabelledPlanes3Initialisation extends StudioInitialisation
{
	...
	public String getDescription() {
		return "Distance-labelled planes 10m - 100m";
	}
	
	private static void addZPlaneText(int zInM, SceneObjectContainer scene, Studio studio)
	{
		scene.addSceneObject(EditableText.getCentredEditableText(
				...
				new Vector3D(0, -110*CM, zInM),	// centre
