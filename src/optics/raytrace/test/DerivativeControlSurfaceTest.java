...
public class DerivativeControlSurfaceTest
{
	...
	{		
		DerivativeControlSurface dcs = new DerivativeControlSurface();
		...
		try {
			System.out.println("back to 3D "+dcs.jamaVector2D2Vector3D(v2D, false, u, v, n)
		...
		try {
			System.out.print(
					"v3D = " + dcs.jamaVector2D2Vector3D(j.times(v2D), false, u, v, n) 
				);
		} catch (EvanescentException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
