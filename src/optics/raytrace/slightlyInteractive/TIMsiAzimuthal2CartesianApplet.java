...
/**
 * A simple interactive TIM that demonstrates the view through a ray-rotation window
 */
public class TIMsiAzimuthal2CartesianApplet extends JApplet
{
	private static final long serialVersionUID = 5225391126046696550L;
	...
	public void init()
	{
		...
		//
		TIMsiBits interactiveBits = new TIMsiAzimuthal2CartesianBits();
