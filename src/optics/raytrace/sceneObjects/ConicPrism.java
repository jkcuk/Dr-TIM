 ...
 */
public class ConicPrism extends SceneObjectPrimitiveIntersection
{
	...
	public ConicPrism(ConicPrism original)
	{
		this(
	...
	@Override
	public ConicPrism clone()
	{
		return new ConicPrism(this);
	}
