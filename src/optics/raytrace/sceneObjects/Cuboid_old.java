 ...
 * 
 */
public class Cuboid_old extends SceneObjectIntersection implements Serializable
{
	 ...
	 * @param original
	 */
	public Cuboid_old(Cuboid_old original)
	{
		this(
	 ...
	 */
	@Override
	public Cuboid_old clone()
	{
		return new Cuboid_old(this);
	}
