 ...
 * inverse objects ("negative" scene-objects), invisible objects, etc.
 * 
 * @author Johannes Courtial
 */ 
public class SceneObjectIntersectionSimple extends SceneObjectContainer implements Serializable
{
	...
	public SceneObjectIntersectionSimple(SceneObjectContainer container, CopyModeType copyMode)
	{
		super(container, copyMode);
	}

	public SceneObjectIntersectionSimple(SceneObjectContainer container)
	{
	...
	{
		return new SceneObjectIntersectionSimple(this, CopyModeType.CLONE_DATA);
	}
...
//					intersection = sceneObjects.get(i).getNextClosestRayIntersection(ray, intersection);
	...
	{
		SceneObjectIntersectionSimple soc = new SceneObjectIntersectionSimple(description + "(transformed)", getParent(), getStudio());
