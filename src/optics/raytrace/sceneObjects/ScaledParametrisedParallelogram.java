...
public class ScaledParametrisedParallelogram extends ParametrisedParallelogram
{
	 ...
	 * @param studio
	 */
	public ScaledParametrisedParallelogram(
			String description, 
			Vector3D corner, 
	 ...
	 * @param original
	 */
	public ScaledParametrisedParallelogram(ScaledParametrisedParallelogram original)
	{
		super(original);
	 ...
	 */
	@Override
	public ScaledParametrisedParallelogram clone()
	{
