...
/**
 * Effects of pixellation demos for SPIE proceedings article
 ...
 */
public class PixellationEffectsSPIE
{   
	// a few units
	...
	public static final boolean SIMULATE_DIFFRACTIVE_BLUR = false;	// simulateDiffractiveBlur
	public static final boolean SIMULATE_RAY_OFFSET = false;	// simulateRayOffset
	public static final double PIXEL_SIDE_LENGTH_MM = 0.25;	// pixelSideLength
	...
	public static final double WINDOW_Z_CM = 4.99;
	public static final double ARRAY_Z_CM = 5;
	...
	{		
		...
		EditableRelativisticAnyFocusSurfaceCamera camera = new EditableRelativisticAnyFocusSurfaceCamera(
				...
				QualityType.RUBBISH,	// TEST?QualityType.BAD:QualityType.GREAT,	// blur quality
