 ...
 */
public class ThreeNestedCloaksRotationVisualiser_old extends NonInteractiveTIMEngine
{
	// parameters
	...
	/**
	 * focal length of base lens of inner cloak
	 */
	private double f1;

	/**
	 * focal length of base lens of middle cloak
	 */
	private double f2;
	
	/**
	 * focal length of base lens of outer cloak
	 */
	private double f3;
	
	/**
	 * angle of base lens of inner cloak w.r.t. y axis
	 */
	private double alpha1Deg;

	/**
	 * angle of base lens of middle cloak w.r.t. y axis
	 */
	private double alpha2Deg;
	
	/**
	 * angle of base lens of outer cloak w.r.t. y axis
	 */
	private double alpha3Deg;
	 ...
	 * Sets all parameters.
	 */
	public ThreeNestedCloaksRotationVisualiser_old()
	{
		super();
...
//        EventQueue.invokeLater(r);
		(new ThreeNestedCloaksRotationVisualiser_old()).run();
	}
}
