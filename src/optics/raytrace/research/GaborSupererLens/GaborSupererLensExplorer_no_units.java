 ...
 *
 */
public class GaborSupererLensExplorer_no_units extends NonInteractiveTIMEngine implements ActionListener
{
	/**
	 ...
	 * Sets all parameters.
	 */
	public GaborSupererLensExplorer_no_units()
	{
		super();
...
//		clasPanel.add(clasInitialisationButton, "span");
	...
	{
		(new GaborSupererLensExplorer_no_units()).run();
	}
}
