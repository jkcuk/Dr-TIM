...
/**
 * Simulate the visual appearance of an ideal-lens wormhole.
 * 
 * @author Johannes Courtial, Jakub Belin
 */
public class IdealLensWormholeVisualiser extends NonInteractiveTIMEngine
implements ChangeListener
{
	 ...
	 * Sets all parameters.
	 */
	public IdealLensWormholeVisualiser()
	{
		super();
...
//		 * @see optics.raytrace.NonInteractiveTIMEngine.cameraPixelsY
		...
		{
			windowTitle = "Dr TIM's ideal-lens-wormhole visualiser";
			windowWidth = 1500;
			windowHeight = 650;
		}
	}
...
//		pointOfInterestTextField.setText(getRotationPoint().toString());
	...
	{
		(new IdealLensWormholeVisualiser()).run();
	}
}
