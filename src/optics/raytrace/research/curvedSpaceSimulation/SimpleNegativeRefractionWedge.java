 ...
 * 
 * @author Johannes Courtial, Dimitris
 */
public class SimpleNegativeRefractionWedge extends NonInteractiveTIMEngine
{
	 ...
	 * Sets all parameters.
	 */
	public SimpleNegativeRefractionWedge()
	{
		super();
	...
	{
		return "SimpleNegativeRefractionWedge"	// the name
	...
	throws SceneException
	{
		...
		double frameRadius = 0.01;
			...
			SurfaceProperty wedgeSurfaces = new RayRotating(
...
//					);
	...
	{
		(new SimpleNegativeRefractionWedge()).run();
	}
}
