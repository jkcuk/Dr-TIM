package optics.raytrace.research.surroundAnaglyph;
...
// import optics.raytrace.cameras.SurroundAnaglyphCamera.ProjectionType;
...
public class SurroundAnaglyphCameraDemo
{
	...
	{
		return "SurroundAnaglyphCameraDemoR.bmp";
	}
	...
	{		
		...
		if(insideSphere)
		{
			...
			studio.setLights(LightSource.getStandardLightsFromBehind(3));
		}
		else
		{
			...
			scene.addSceneObject(new EditableParametrisedCylinder(
					"cylinder",	// description,
					new Vector3D(-5, -0.5, -5),	// startPoint,
		...
		double
			verticalAngleOfView = 1*180.0;	// in degrees
		int
