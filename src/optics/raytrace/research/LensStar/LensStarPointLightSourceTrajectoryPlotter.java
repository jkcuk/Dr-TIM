...
/**
 * Plots a number of trajectories from a point light source in a lens star.
 * 
 * @author Johannes Courtial
 */
public class LensStarPointLightSourceTrajectoryPlotter
{
	...
	{
		return "LensStarPointLightSourceTrajectory"	// the name
			+ " point-light-source distance "+POINT_LIGHT_SOURCE_DISTANCE
		...
		)
	{
		...
		scene.addSceneObject(new EditableRayTrajectory(
				name,
				new Vector3D(0, 0, POINT_LIGHT_SOURCE_DISTANCE),	// start point
				0,	// start time
