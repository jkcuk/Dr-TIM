 ...
 * 
 * Calculates a movie of the ray trajectory through a lens-TO tetrahedron, with the trajectory changing.
 * 
 * @author Johannes Courtial
 */
public class LensTOTetrahedronTrajectoryMovieMaker1
{
	/**
	...
	{
		return "LensTOTetrahedronTrajectory1_"+	// the name
