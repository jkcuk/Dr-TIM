 ...
 */
public class IdealLensCloakMovieMaker
{
	public static final boolean SHOW_TETRAHEDRON = true;
	public static final boolean SHOW_FRAMES = false;	// false;
	public static final boolean PLACEHOLDER_WINDOWS = false;	// false;
...
//	public static final boolean SHOW_CYLINDER_ARRAY = false;	// in focus plane
	...
	{
		return "IdealLensCloakMovieMaker"	// the name
...
//				+(SHOW_SPHERE_ARRAY?" (with sphere array)":"")
		...
		if(SHOW_TETRAHEDRON)
		{
			scene.addSceneObject(
				new EditableIdealLensCloak(
						...
						0.1*2.0*1./3,	// heightLowerInnerVertexE
						0.9,	// 0.9,	// 0.96,	// interface transmission coefficient
	...
	public static void main(final String[] args)
	{
		...
		for(int frame = 100; frame < getNoOfFrames(); frame++)
		{
