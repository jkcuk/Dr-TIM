 ...
 * 
 * Corresponds to frame 75 of the ExtendedRochesterCloakViewpointMovie.
 * 
 * Calculates a movie of the ray trajectory through an extended Rochester cloak, with the trajectory changing.
 * 
 * @author Johannes Courtial
 */
public class ExtendedRochesterCloakTrajectoryMovieMaker1
{
	/**
	...
	{
		return "ExtendedRochesterCloakTrajectory1_"+	// the name
