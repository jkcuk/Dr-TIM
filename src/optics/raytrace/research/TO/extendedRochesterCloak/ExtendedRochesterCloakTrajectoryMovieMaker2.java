 ...
 * 
 * Corresponds to frame 0 of the ExtendedRochesterCloakViewpointMovie.
 * 
 * Calculates a movie of the ray trajectory through an extended Rochester cloak, with the trajectory changing.
 * 
 * @author Johannes Courtial
 */
public class ExtendedRochesterCloakTrajectoryMovieMaker2
{
	/**
	...
	{
		return "ExtendedRochesterCloakTrajectory2_"+	// the name
	...
	public static Studio createStudio(int frame)
	{
		...
		scene.addSceneObject(new EditableRayTrajectory(
						...
						0,	// start time
						new Vector3D(0, -1.5+3.*frame/getNoOfFrames() - 10*Math.sin(angle), 9-10+10*Math.cos(angle)),	// initial direction
						0.01,	// radius
