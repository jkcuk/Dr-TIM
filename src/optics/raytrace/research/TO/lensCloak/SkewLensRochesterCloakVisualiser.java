 ...
 */
public class SkewLensRochesterCloakVisualiser extends NonInteractiveTIMEngine
{
	//
	...
	/**
	 * Addition of Tim's Head
	 */
	private boolean showTimHead;
	/**
	 * Position of the centre of Tim's Head
	 */
	private Vector3D TimHeadCentre;
	/**
	 * Radius of the TimHead
	 */
	private double TimHeadRadius;
	 ...
	 * Sets all parameters.
	 */
	public SkewLensRochesterCloakVisualiser()
	{
		super();
		...
		patternedSphereCentre = new Vector3D(0, 1, 0);
		patternedSphereRadius = 0.05;
		showTimHead = true;
		TimHeadCentre = new Vector3D(0.8, 0.25, (z4-z1)/2);
		TimHeadRadius = 0.5;
	...
	public void writeParameters(PrintStream printStream)
	{
		...
		printStream.println("showTimHead = "+showTimHead);
		printStream.println("TimHeadCentre = "+TimHeadCentre) ;
			...
			throws SceneException
	{
		...
		EditableTimHead TimHead = new EditableTimHead (
				...
				TimHeadCentre,  //centre
				TimHeadRadius, // radius
				new Vector3D(-0.5, 0, -1), // front direction
				new Vector3D(-0.5, 1, 0), // top direction
				new Vector3D(1, 0, 0), // right direction
				scene, studio); // parent
		scene.addSceneObject(TimHead, showTimHead);
	...
	private JCheckBox showTimHeadCheckBox;
	private LabelledVector3DPanel SphereCentrePanel;
	private LabelledVector3DPanel TimCentrePanel;
	...
	protected void createInteractiveControlPanel()
	{
		...
		f2Panel.getDoublePanel().setText("not initialised");
		...
		f3Panel.getDoublePanel().setText("not initialised");
		...
		f4Panel.getDoublePanel().setText("not initialised");
		...
		lensTypeComboBox.setEnabled(false);
		// TODO
		...
		JPanel SphereCentreJPanel = new JPanel();
		SphereCentreJPanel.setBorder(GUIBitsAndBobs.getTitledBorder("Patterned Sphere Position"));
		SphereCentreJPanel.setLayout(new MigLayout("insets 0"));
		otherObjectsPanel.add(SphereCentreJPanel, "span");

		SphereCentrePanel = new LabelledVector3DPanel("Position");
		SphereCentrePanel.setVector3D(patternedSphereCentre);
		SphereCentreJPanel.add(SphereCentrePanel, "span");

		showTimHeadCheckBox = new JCheckBox("Show Tim");
		showTimHeadCheckBox.setSelected(showTimHead);
		otherObjectsPanel.add(showTimHeadCheckBox, "span");

		JPanel TimCentreJPanel = new JPanel();
		TimCentreJPanel.setBorder(GUIBitsAndBobs.getTitledBorder("Tim Head Position"));
		TimCentreJPanel.setLayout(new MigLayout("insets 0"));
		otherObjectsPanel.add(TimCentreJPanel, "span");

		TimCentrePanel = new LabelledVector3DPanel("Position");
		TimCentrePanel.setVector3D(TimHeadCentre);
		TimCentreJPanel.add(TimCentrePanel, "span");
	...
	protected void acceptValuesInInteractiveControlPanel()
	{
		...
		showTimHead = showTimHeadCheckBox.isSelected();
		patternedSphereCentre = SphereCentrePanel.getVector3D();
		TimHeadCentre = TimCentrePanel.getVector3D();
