 ...
 */
public class PlanarPhaseHologramIdealLensLookalikeVisualiser_old extends NonInteractiveTIMEngine
{
	 ...
	 * Sets all parameters.
	 */
	public PlanarPhaseHologramIdealLensLookalikeVisualiser_old()
	{
		super();
...
//		nonInteractiveTIMAction = NonInteractiveTIMActionEnum.MOVIE;
	...
	throws SceneException
	{
		...
		try {
			...
			EditableFramedWindow idealThinLens = new EditableFramedWindow(
...
//		// add a tiny sphere at the position b
		...
		EditableFramedWindow phaseHologram1 = new EditableFramedWindow(
		...
		EditableFramedWindow phaseHologram2 = new EditableFramedWindow(
...
//        EventQueue.invokeLater(r);
		(new PlanarPhaseHologramIdealLensLookalikeVisualiser_old()).run();
	}
}
