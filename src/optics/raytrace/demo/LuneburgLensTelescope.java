 ...
 */
public class LuneburgLensTelescope
{
	/**
	...
	{
		return "LuneburgLensTelescope" + frameNumberString + ".bmp";
	}
	...
	{		
		...
		double frontRadius = 0.5+frameNumber*1./40.;
		
		scene.addSceneObject(
				new LuneburgLens(
						"front Luneburg lens",
						new Vector3D(0, 0, 6),	// centre
						frontRadius,	// radius
	...
	public static void main(final String[] args)
	{
		...
		for(int frameNumber = 0; frameNumber<=40; frameNumber++)
		{
