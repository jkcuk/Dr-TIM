 ...
 */
public class Relativistic3DTVCameraDemo
{
	/**
	...
	{		
		...
		CameraClass camera = new Relativistic3DTVCamera(
				...
				OrientationType.HORIZONTAL,	// frame-packing orientation
				0,	// gap between frames
