...
/*
 * Source: https://github.com/tips4java/tips4java/blob/main/source/MessageConsole.java
 * slightly modified by Johannes
 * 
...
public class MessageConsole
{
	 ...
	 * @param rows
	 * @param columns
	 * @return	a JTextArea inside a JScrollPane to which System.out and System.err have been redirected
	 */
	public static JComponent createConsole(int rows, int columns)
	{
		//  see see https://stackoverflow.com/questions/4443878/redirecting-system-out-to-jtextpane
		JTextComponent textComponent = new JTextArea(rows, columns);
