...
/**
 * @author johannes
 * from http://examples.oreilly.com/learnjava2/CD-ROM/examples/ch21/magicbeans/src/magicbeans/
 */
public class Dial extends JComponent {
	private static final long serialVersionUID = -179268879648561567L;
	...
	public Dial(int minValue, int maxValue, int value) {
		...
		addMouseListener(new MouseAdapter(){
			@Override
			public void mouseReleased(MouseEvent e) { fireEvent(); }
		});
	}
...
//		});
		...
		dial.addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent e) {
				statusLabel.setText("Value is " + ((Dial)e.getSource()).getValue());
			}
		});
