...
/**
 * An editable gCLA cloak, with the windows optionally framed.
 ...
 */
public class EditableGCLAsCloak extends EditableSceneObjectCollection implements ActionListener
{
	private static final long serialVersionUID = -6833267076655670182L;

	public enum GCLACloakType
	{
		PRISMATIC("Square prismatic"),
		OCTAHEDRAL("Octahedral");
		
		private String description;
		private GCLACloakType(String description)
		{
	...
	private GCLACloakType cloakType;
	...
	public EditableGCLAsCloak(SceneObject parent, Studio studio)
	{
		this(
				"Cloak",
				...
				GCLACloakType.OCTAHEDRAL,	// cloak type
				true,	// show frames
	 ...
	 * @param original
	 */
	public EditableGCLAsCloak(EditableGCLAsCloak original)
	{
		this(
	...
	@Override
	public EditableGCLAsCloak clone()
	{
		return new EditableGCLAsCloak(this);
	}
...
//	}
	...
	private void addInterfacesForPrismaticCloakFace(String faceName, Vector3D cloakCentre2FaceCentre, Vector3D right, Vector3D up)
	{
		...
		// interior gCLAs
		GCLAsWithApertures window2 = new GCLAsWithApertures(Vector3D.Z, Vector3D.X, Vector3D.Y, eta2, eta2, deltax2, 0, GlobalOrLocalCoordinateSystemType.LOCAL_OBJECT_BASIS, gCLAsTransmissionCoefficient, false);
	...
	{		
		...
		GCLAsWithApertures sheet3 = new GCLAsWithApertures(Vector3D.Z, Vector3D.X, Vector3D.Y, eta3, eta3, 0, 0, GlobalOrLocalCoordinateSystemType.LOCAL_OBJECT_BASIS, gCLAsTransmissionCoefficient, false);
	 ...
	 */
	@Override
	public EditableGCLAsCloak acceptValuesInEditPanel()
	{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		iPanel.replaceFrontComponent(container, "Edit ex-cloak");
