...
/**
 * A wedge that simulates an angle of non-existing, "cancelled", space.
 * The wedge is described by its apex edge, which is the common edge of the two faces, the "leg faces", that are imaged into each other such that it looks like the
 * space between them isn't there.
 * The angle of the cancelled bit of space, which is also the angle between the leg faces, is given by the apex angle.
 * The two leg faces can be either rectangles or triangles, depending on
 ...
 */
public class EditableSpaceCancellingWedge_under_construction extends EditableSceneObjectCollection implements ActionListener
{
	...
	private SCWedgeLegFaceShape sCWedgeLegFaceShape;
	 ...
	 * @param studio
	 */
	public EditableSpaceCancellingWedge_under_construction(
			String description,
			double apexAngle,
			...
			SCWedgeLegFaceShape sCWedgeLegFaceShape,
	...
	)
	{
		...
		this.sCWedgeLegFaceShape = sCWedgeLegFaceShape;
	 ...
	 * @param studio
	 */
	public EditableSpaceCancellingWedge_under_construction(SceneObject parent, Studio studio)
	{
		this(
				...
				1,	// legLength
				1,	// apexEdgeLength
				SCWedgeLegFaceShape.RECTANGULAR,	// sCWedgeFaceShape
	 ...
	 * @param original
	 */
	public EditableSpaceCancellingWedge_under_construction(EditableSpaceCancellingWedge_under_construction original)
	{
		this(
			...
			original.getsCWedgeLegFaceShape(),
	...
	@Override
	public EditableSpaceCancellingWedge_under_construction clone()
	{
		return new EditableSpaceCancellingWedge_under_construction(this);
	}
	...
	public SCWedgeLegFaceShape getsCWedgeLegFaceShape() {
		return sCWedgeLegFaceShape;
	}

	public void setsCWedgeLegFaceShape(SCWedgeLegFaceShape sCWedgeFaceShape) {
		this.sCWedgeLegFaceShape = sCWedgeFaceShape;
	}
	...
	/**
	 * Add one of the surfaces that form the "leg faces" of the isosceles negative-space wedges
	 * @param description
	 * @param angleWithBisector
	 * @param longLeg	in the planar-mirror version, every other leg is a "long leg"
	 */
...
//		case TRIANGULAR:
	...
	/**
	 * Add a black surface opposite the apex edge
	 * @param description
	 * @param angleWithBisector1
	 * @param angleWithBisector2
	 */
	 ...
	 */
	@Override
	public EditableSpaceCancellingWedge_under_construction acceptValuesInEditPanel()
	{
