...
public class DoubleColour implements Serializable
{
	...
	RED	= new DoubleColour(1,0,0),
	GREEN	= new DoubleColour(0,1,0),
	BLUE	= new DoubleColour(0,0,1),
	BLACK	= new DoubleColour(0,0,0),
	WHITE	= new DoubleColour(1,1,1),
	WHITER	= new DoubleColour(2,2,2),
	GREY10 	= new DoubleColour(0.1, 0.1, 0.1),
	GREY20 	= new DoubleColour(0.2, 0.2, 0.2),
	GREY30 	= new DoubleColour(0.3, 0.3, 0.3),
	GREY40 	= new DoubleColour(0.4, 0.4, 0.4),
	GREY50 	= new DoubleColour(0.5, 0.5, 0.5),
	GREY60 	= new DoubleColour(0.6, 0.6, 0.6),
	GREY70 	= new DoubleColour(0.7, 0.7, 0.7),
	GREY80 	= new DoubleColour(0.8, 0.8, 0.8),
	GREY90 	= new DoubleColour(0.9, 0.9, 0.9),
	GREY95 	= new DoubleColour(0.95, 0.95, 0.95),
//	ORANGE	= new DoubleColour(1,0.5,0),
	BROWN = new DoubleColour(165./256., 42./256., 42./256.),	// from http://kb.iu.edu/data/aetf.html
	YELLOW  = new DoubleColour(1.0, 1.0, 0.0),
	YELLOW_SUPERBRIGHT  = new DoubleColour(2.0, 2.0, 0.0),
	ORANGE = new DoubleColour(1.0, 165./255., 0),	// Orange (web color) (Hex: #FFA500) (RGB: 255, 165, 0) (from http://simple.wikipedia.org/wiki/Orange)
	PURPLE = new DoubleColour(0.5, 0., 0.5),	// Purple (from https://simple.wikipedia.org/wiki/Purple)
	VIOLET = new DoubleColour(143./255., 0., 1.0),	// Violet (Electric Violet) (Middle Violet) (from https://simple.wikipedia.org/wiki/Violet)
	LILAC = new DoubleColour(200./255., 162./255., 200./255.),	// Lilac (Hex: #CAA2C8) (RGB: 200, 162, 200) (from https://simple.wikipedia.org/wiki/Purple)
	INDIGO = new DoubleColour(102./255., 0., 1.),	// Indigo (Electric Indigo) (Hex: #6600FF) (RGB: 102, 0, 255) (from https://simple.wikipedia.org/wiki/Purple)
	LAVENDER = new DoubleColour(181./255., 126./255., 220./255.),	// Lavender (Floral Lavender) (Maerz & Paul) (Hex: #B57EDC) (RGB: 181,126,220) (from https://simple.wikipedia.org/wiki/Purple)
	LIGHT_BLUE	= new DoubleColour(0.5, 0.5, 1),
	DARK_BLUE	= new DoubleColour(0, 0, 0.5),
	LIGHT_RED 	= new DoubleColour(1, 0.5, 0.5),
	DARK_RED	= new DoubleColour(0.5, 0, 0),
	SKIN = new DoubleColour(239./256., 208./256., 207./256.),
	CYAN = new DoubleColour(0, 198./255., 200./255.);
	...
	{
		return new DoubleColour(1-colour.red, 1-colour.green, 1-colour.blue);
	}
	...
	{
		return new DoubleColour(c1.getR() + c2.getR(), c1.getG() + c2.getG(), c1.getB() + c2.getB());
	}

	public DoubleColour add(DoubleColour c) {
		return new DoubleColour(red + c.getR(), green + c.getG(), blue + c.getB());
	}

	public DoubleColour multiply(double f)
	{
		return new DoubleColour(f*red, f*green, f*blue);
	}
	...
	{
		return new DoubleColour(Math.sqrt(red), Math.sqrt(green), Math.sqrt(blue));
	}
